...
I front-loaded the work with as much clarity as possible: specs, PRDs, vertically sliced detailed GitHub issues, test-driven development, review expectations, and clear instructions for how the agent should interact with the repo and PRs.
